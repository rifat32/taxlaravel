...
<head>
    ...
    <title>মুক্তিযোদ্ধা প্রত্যয়ন পত্র</title>
    <link href="{{asset('css/prottoyonSonodPotro/CSS/freedomfighterLetter.css')}}" rel="stylesheet" type="text/css"/>
<style>
.bg-img {
...
<body>
    <section class="freedomfighter-section bg-img">
        <div class="freedomfighter-header">
        ...
        <div class="freedomfighter-title">
            <h3>মুক্তিযোদ্ধা প্রত্যয়ন পত্র</h3>
            <h3>সনদ নম্বর - {{$services->id}}</h3>
        </div>

        <div class="freedomfighter-address">
            <p><span></span>এই মর্মে প্রত্যয়ন করা যাইতেছে যে, {{$services->applicant_name}}, পিতা- {{$services->applicant_f_name}}, মাতা- {{$services->applicant_m_name}}, গ্রাম- {{$services->village_name}}, ডাকঘর- {{$services->post_office}}, থানা- {{$services->upazila_name}}, উপজেলা- {{$services->upazila_name}}, জেলা- {{$services->district_name}}, তাঁহাকে আমি চিনি ও জানি। তিনি অত্র ইউনিয়ন পরিষদের {{$services->ward_no}}
                ওয়ার্ডের স্থায়ী বাসিন্দা। আমার জানা মতে, তিনি একজন প্রকৃত মুক্তিযোদ্ধা, তাঁহার মুক্তিযোদ্ধা গেজেট নং- {{$services->fighter_gadget_number}}, তারিখ- {{$services->fighter_date}} ইং এবং সাময়িক সনদপত্র নং- {{$services->fighter_certificat_number}}।</p>
        </div>

        <div class="freedomfighter-details">
