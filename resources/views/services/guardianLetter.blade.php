...
<head>
    ...
    <title>অভিভাবক আয়ের প্রত্যয়ন পত্র</title>
    <link href="{{asset('css/prottoyonSonodPotro/CSS/guardianLetter.css')}}" rel="stylesheet" type="text/css"/>
<style>
.bg-img {
...
<body>
    <section class="guardian-section bg-img">
        ...
        <div class="guardian-title">
            <h3>অভিভাবক আয়ের প্রত্যয়ন পত্র</h3>
            <h3>সনদ নম্বর - {{$services->id}}</h3>
        </div>

        <div class="guardian-address">
            <p><span></span>এই মর্মে প্রত্যয়ন করা যাইতেছে যে, {{$services->applicant_name}}, পিতা- {{$services->applicant_f_name}}, মাতা- {{$services->applicant_m_name}}, গ্রাম- {{$services->village_name}}, ডাকঘর- {{$services->post_office}}, থানা-  {{$services->upazila_name}}, উপজেলা-  {{$services->upazila_name}}, জেলা- {{$services->district_name}}, তাহাকে আমি চিনি ও জানি। তিনি অত্র ইউনিয়ন পরিষদের {{$services->ward_no}}
                ওয়ার্ডের স্থায়ী বাসিন্দা। আমার জানা মতে, উপরোক্ত ব্যক্তির পিতা- {{$services->applicant_f_name}} এর মাসিক আয় {{$services->gardian_income}} এবং তিনি পেশায় একজন দিন {{$services->gardian_occupaion}}।</p>
        </div>
